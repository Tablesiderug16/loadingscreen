...
config.music_playlist = [
	{
		name: "Suspect (AGB) - Bags And Bodies (Official Audio) #Suspiciousactivity",
		file: "sideways_samba.ogg",
	},
	{
		name: "Suspect (AGB) - Bags And Bodies (Official Audio) #Suspiciousactivity",
		youtube: "https://www.youtube.com/watch?v=yvieA-nxA7o",
	},
	{
...
config.messages_list = [
	"Welcome to HashRP!",
	"Please wait while you load into the server!",
	"Enjoy!",
]
